...
jamais.treesitter = {
    TSComment = {fg = c.light_grey, bg = c.none, style = cfg.italic_comment},
    TSConditional = {fg = c.orange, style = cfg.italic_keyword},
    TSKeyword = {fg = c.purple, style = cfg.italic_keyword},
    TSAnnotation = {fg = c.orange},
    TSRepeat = {fg = c.orange, style = cfg.italic_keyword},
    ...
    TSFunction = {fg = c.yellow, style = cfg.italic_function .. cfg.bold},
    TSMethod = {fg = c.purple, style = cfg.italic_function},
    TSKeywordReturn = {fg = c.orange, style = cfg.italic},
    TSConstructor = {fg = c.fg},
    TSFuncBuiltin = {fg = c.yellow, style = cfg.italic_function},
    TSConstant = {fg = c.purple},
    TSVariable = {fg = c.fg, style = cfg.italic_variable},
