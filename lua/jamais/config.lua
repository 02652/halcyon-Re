local is_valid  = require("jamais.utils").is_valid
...
-- style check
if not is_valid(vim.g.jamais_italic_comment) then
    styles.italic_comment = "NONE"
end

if not is_valid(vim.g.jamais_italic_keyword) then
    styles.italic_keyword = "NONE"
end

if not is_valid(vim.g.jamais_italic_boolean) then
    styles.italic_boolean = "NONE"
end

if not is_valid(vim.g.jamais_italic_function) then
    styles.italic_function = "NONE"
end

if not is_valid(vim.g.jamais_italic_variable) then
    styles.italic_variable = "NONE"
end

if not is_valid(vim.g.jamais_bold) then
    styles.bold = "NONE"
end
